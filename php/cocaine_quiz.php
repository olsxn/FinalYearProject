...
$questionTextSQL_1 = "SELECT question_text FROM cocaine_questions WHERE question_id ='1'";
$questionResult1 = $conn->query($questionTextSQL_1);

$questionTextSQL_2 = "SELECT question_text FROM cocaine_questions WHERE question_id ='2'";
$questionResult2 = $conn->query($questionTextSQL_2);

$questionTextSQL_3 = "SELECT question_text FROM cocaine_questions WHERE question_id ='3'";
$questionResult3 = $conn->query($questionTextSQL_3);

// get answers here
$answerTextSQL_1 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '1' AND question_id = '1'";
$answerResult1 = $conn->query($answerTextSQL_1);

$answerTextSQL_2 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '2' AND question_id = '1'";
$answerResult2 = $conn->query($answerTextSQL_2);

$answerTextSQL_3 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '3' AND question_id = '1'";
$answerResult3 = $conn->query($answerTextSQL_3);

$answerTextSQL_4 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '4' AND question_id = '2'";
$answerResult4 = $conn->query($answerTextSQL_4);

$answerTextSQL_5 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '5' AND question_id = '2'";
$answerResult5 = $conn->query($answerTextSQL_5);

$answerTextSQL_6 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '6' AND question_id = '2'";
$answerResult6 = $conn->query($answerTextSQL_6);

$answerTextSQL_7 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '7' AND question_id = '3'";
$answerResult7 = $conn->query($answerTextSQL_7);

$answerTextSQL_8 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '8' AND question_id = '3'";
$answerResult8 = $conn->query($answerTextSQL_8);

$answerTextSQL_9 = "SELECT answer_text FROM cocaine_answers WHERE answer_id = '9' AND question_id = '3'";
...
<html lang="en">
  ...
  <body>
      ...
      <h1 style="text-align: center; font-weight: 600; color: white;">Cocaine Quiz</h1>
      <!-- container for body -->
      <div class="container-fluid">
          <div class="container-fluid bg-dark shadow rounded">
              <div class="col-lg-12 text-white">
      <form action="cocaine_dest.php" method="post" id="cocaine_quiz">
    <!-- display question1 -->
